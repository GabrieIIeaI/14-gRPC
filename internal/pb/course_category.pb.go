...
type GetCategoryFilters struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetCategoryFilters) Reset() {
	*x = GetCategoryFilters{}
	mi := &file_proto_course_category_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetCategoryFilters) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetCategoryFilters) ProtoMessage() {}

func (x *GetCategoryFilters) ProtoReflect() protoreflect.Message {
	mi := &file_proto_course_category_proto_msgTypes[4]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetCategoryFilters.ProtoReflect.Descriptor instead.
func (*GetCategoryFilters) Descriptor() ([]byte, []int) {
	return file_proto_course_category_proto_rawDescGZIP(), []int{4}
}

func (x *GetCategoryFilters) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
var file_proto_course_category_proto_rawDesc = []byte{
	...
	0x44, 0x12, 0x16, 0x2e, 0x70, 0x62, 0x2e, 0x47, 0x65, 0x74, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f,
	0x72, 0x79, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x73, 0x1a, 0x0c, 0x2e, 0x70, 0x62, 0x2e, 0x43,
...
var file_proto_course_category_proto_goTypes = []any{
	...
	(*GetCategoryFilters)(nil),    // 4: pb.GetCategoryFilters
}
var file_proto_course_category_proto_depIdxs = []int32{
	...
	4, // 5: pb.CategoryService.GetCategoryByID:input_type -> pb.GetCategoryFilters
