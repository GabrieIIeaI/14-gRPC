...
type CategoryServiceClient interface {
	...
	GetCategoryByID(ctx context.Context, in *GetCategoryFilters, opts ...grpc.CallOption) (*Category, error)
}
...
func (c *categoryServiceClient) GetCategoryByID(ctx context.Context, in *GetCategoryFilters, opts ...grpc.CallOption) (*Category, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Category)
...
type CategoryServiceServer interface {
	...
	GetCategoryByID(context.Context, *GetCategoryFilters) (*Category, error)
...
func (UnimplementedCategoryServiceServer) GetCategoryByID(context.Context, *GetCategoryFilters) (*Category, error) {
...
func _CategoryService_GetCategoryByID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CategoryServiceServer).GetCategoryByID(ctx, req.(*GetCategoryFilters))
	}
	return interceptor(ctx, in, info, handler)
}
